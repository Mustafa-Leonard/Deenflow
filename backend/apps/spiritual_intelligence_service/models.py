...
class TrendAnalysis(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    metric_name = models.CharField(max_length=50) # e.g., "salah_consistency"
...
class Streak(models.Model):
    ...
    category = models.CharField(max_length=50) # e.g., "Daily Prayer", "Quran Reading"
...
class SpiritualReport(models.Model):
